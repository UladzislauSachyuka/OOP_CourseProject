namespace Project
{
    partial class ProfileView
    {
        ...
        private void InitializeComponent()
        {
            ...
            save_changes_button = new Button();
            label8 = new Label();
            label7 = new Label();
            label6 = new Label();
            label5 = new Label();
            ...
            panel2.Controls.Add(save_changes_button);
            ...
            label.Location = new Point(193, 25);
            label.Name = "label";
            label.Size = new Size(237, 35);
            label.TabIndex = 58;
            ...
            // save_changes_button
            // 
            save_changes_button.BackColor = Color.FromArgb(78, 184, 206);
            save_changes_button.Cursor = Cursors.Hand;
            save_changes_button.FlatAppearance.BorderSize = 0;
            ...
            save_changes_button.TabStop = false;
            save_changes_button.Text = "Сохранить изменения";
            save_changes_button.UseVisualStyleBackColor = false;
            save_changes_button.Click += save_changes_button_Click;
            // 
            // label8
            // 
